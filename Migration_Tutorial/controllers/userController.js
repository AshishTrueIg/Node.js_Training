...
const oneToOneUser = async (req,res)=>{
    var  data = await User.create({firstName: "mohit" , lastName:"kumar"});
    res.status(200).json({data:data})
}

export default  {addUser , getUser , getUserById , postUsers , deleteUser , patchUser , putUserData ,oneToOneUser};